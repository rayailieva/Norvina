...
public class Constants {
    ...
    public final static String USERNAME_LENGTH = "Username must be at least 3 characters long!";

    public final static String DESCRIPTION_LENGTH = "Description must be at least 3 characters long!";

    public final static String IMAGE_NULL= "Image cannot be null!";

    public final static String PRICE_VALUE = "Price value must be at least 1!";
    ...
    public final static String FIRST_NAME_LENGTH = "First name must contain at least 2 characters!";

    public final static String LAST_NAME_LENGTH = "Last name must contain at least 2 characters!";
